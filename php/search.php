...
<br> 
<br>
<h2 class="text-white mb-4">Nordic Guides - Search results</h2>
<?php if(isset($msg)) echo $msg?>
<p class="text-white mb-4" >Your search results from cities:</p>
<?php
...
<br>
<br>
<p class="text-white mb-4">Your search results from guides:</p>
<table class="table table-hover" style='color:white;'>
    <thead>
      <tr>
        <th>Name</th>
